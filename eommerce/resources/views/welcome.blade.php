...
<html lang="en">
    ...
    <header>
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-end">
  ...
  <ul class="d-flex justify-content-end list-unstyled m-0 gap-1">
    <!-- User Dropdown -->
    <li class="relative" x-data="{ open: false }">
      <button 
        ...
        class="p-2 flex items-center focus:outline-none transition-all duration-200 hover:bg-gray-100 rounded-full relative z-10"
      >
        <svg width="24" height="24" class="text-gray-700 hover:text-gray-900 transition-colors">
          <use xlink:href="#user"></use>
        </svg>
      </button>

      <!-- Chatbox-style Dropdown -->
      <div 
        x-show="open"
        @mouseenter="open = true"
        ...
        class="absolute right-0 mt-3 w-64 origin-top-right bg-white rounded-lg shadow-xl border border-gray-200 z-50"
        style="display: none"
      >
        <!-- Chatbox pointer -->
        <div class="absolute -top-2 right-3 w-4 h-4 transform rotate-45 bg-white border-t border-l border-gray-200"></div>
        
        <div class="p-4">
          <h3 class="px-2 py-3 text-base font-semibold text-gray-800">Welcome to Our Store</h3>
          <div class="space-y-3">
            <a href="#" 
               class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-all focus:bg-gray-50"
               @mousedown.prevent> <!-- Prevent immediate blur -->
            ...
            <a href="#" 
               class="flex items-center px-4 py-3 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-all focus:bg-blue-600"
               @mousedown.prevent> <!-- Prevent immediate blur -->
    ...
    <li>
      <a href="#" class="p-2 flex items-center transition-all duration-200 hover:bg-gray-100 rounded-full">
        <svg width="24" height="24" class="text-gray-700 hover:text-gray-900">
          <use xlink:href="#wishlist"></use>
        </svg>
      </a>
    </li>
    <li>
      <a href="#" class="p-2 flex items-center transition-all duration-200 hover:bg-gray-100 rounded-full relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
        <svg width="24" height="24" class="text-gray-700 hover:text-gray-900">
          ...
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper">
                <div class="swiper-wrapper">
                    ...
                    <a href="{{ $category->category_page_link ?? route('categories.show', $category->id) }}" 
                      class="nav-link swiper-slide text-center"
                      target="{{ $category->category_page_link ? '_blank' : '_self' }}">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-1.png" alt="Whole Wheat Sandwich Bread" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Whole Wheat Sandwich Bread</h3>
          
          <div class="flex items-center space-x-1 text-yellow-400">
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-half"></use></svg>
            <span class="text-gray-500 text-xs ml-1">(222)</span>
          </div>

          <div class="flex justify-center items-center gap-2 text-sm">
            <del class="text-gray-400">$24.00</del>
            <span class="text-gray-900 font-semibold">$18.00</span>
            <span class="text-xs bg-gradient-to-r from-green-500 to-green-600 text-white rounded px-1 animate-pulse">
              10% OFF
            </span>
          </div>
          ...
          <div class="w-full pt-0">
            <div class="flex gap-2 mt-2">
              <input type="number" name="quantity" class="w-1/4 border border-gray-300 rounded px-2 py-1 text-sm" value="1">
              
              <a href="#" class="w-2/3 bg-green-600 hover:bg-yellow-400 text-white text-sm transition-all duration-300 ease-in-out flex items-center justify-center gap-1 rounded px-2 py-2">
                <svg class="w-4 h-4 fill-current"><use xlink:href="#cart"></use></svg>
                Add to Cart
              </a>
              
              <a href="#" class="w-1/5 border border-gray-400 text-gray-700 hover:bg-gray-100 rounded flex items-center justify-center p-2">
                <svg class="w-4 h-4 fill-current"><use xlink:href="#heart"></use></svg>
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-2.png" alt="Whole Grain Oatmeal" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Whole Grain Oatmeal</h3>
          ...
          <div class="flex items-center space-x-1 text-yellow-400">
            ...
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
            <svg class="w-4 h-4 fill-current"><use xlink:href="#star-half"></use></svg>
            <span class="text-gray-500 text-xs ml-1">(41)</span>
          </div>

          <div class="flex justify-center items-center gap-2 text-sm">
            <del class="text-gray-400">$54.00</del>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-3.png" alt="Sharp Cheddar Cheese Block" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Sharp Cheddar Cheese Block</h3>
          ...
          <div class="flex justify-center items-center gap-2 text-sm">
            <del class="text-gray-400">$14.00</del>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-4.png" alt="Organic Baby Spinach" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Organic Baby Spinach</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-5.png" alt="Organic Spinach Leaves" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Organic Spinach Leaves</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-6.png" alt="Fresh Salmon" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Fresh Salmon</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-7.png" alt="Imported Italian Spaghetti Pasta" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Imported Italian Spaghetti Pasta</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-8.png" alt="Granny Smith Apples" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Granny Smith Apples</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-9.png" alt="Organic 2% Reduced Fat Milk" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Organic 2% Reduced Fat Milk</h3>
    ...
    <div class="w-full p-2">
      <div class="bg-white shadow-sm border rounded-md overflow-hidden">
        <figure class="p-3">
          <a href="index.html" title="Product Title">
            <img src="images/product-thumb-10.png" alt="Greek Style Plain Yogurt" class="h-48 w-auto mx-auto object-contain">
          </a>
        </figure>
        <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
          <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-11.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
                    <div>
                      <div class="flex items-center space-x-1 text-yellow-400">
                        <svg width="18" height="18" class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="w-4 h-4 fill-current"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="w-4 h-4 fill-current"><use xlink:href="#star-half"></use></svg>
                      </div>
                      <span class="text-gray-500 text-xs ml-1">(222)</span>
                    </div>
                    <div class="flex justify-center items-center gap-2 text-sm">
                      <del class="text-gray-400">$24.00</del>
                      <span class="text-gray-900 font-semibold">$18.00</span>
                      <span class="text-xs bg-gradient-to-r from-green-500 to-green-600 text-white rounded px-1 animate-pulse">10% OFF</span>
                    </div>
                    <div class="w-full pt-0">
                      <div class="flex gap-2 mt-2">
                        <input type="number" name="quantity" class="w-1/4 border border-gray-300 rounded px-2 py-1 text-sm" value="1">
                       <a href="#" class="w-2/3 bg-green-600 hover:bg-yellow-400 text-white text-sm transition-all duration-300 ease-in-out flex items-center justify-center gap-1 rounded px-2 py-2"><svg class="w-4 h-4 fill-current"><use xlink:href="#cart"></use></svg>Add to Cart</a>
                        <a href="#" class="w-1/5 border border-gray-400 text-gray-700 hover:bg-gray-100 rounded flex items-center justify-center p-2"><svg width="18" height="18"><use xlink:href="#heart"></use></svg></a>
                      </div>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-12.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
                 ...
                 <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-13.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
                 ...
                 <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-14.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
                 ...
                 <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-15.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
                 ...
                 <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/product-thumb-16.png" alt="Product Thumbnail" class="h-48 w-auto mx-auto object-contain">
                    </a>
                  </figure>
                  <div class="flex flex-col items-center text-center px-4 pb-4 space-y-2">
                    <h3 class="text-sm font-normal">Greek Style Plain Yogurt</h3>
  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row justify-between items-center my-6">
      <h2 class="text-2xl font-semibold">Our Recent Blog</h2>
      <a href="#" class="btn btn-primary bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">View All</a>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <!-- Blog Card -->
      <article class="bg-white border border-gray-100 shadow-sm rounded-lg p-4 transform transition-transform duration-300 hover:scale-[1.03]">
        <div class="overflow-hidden rounded-md">
          <a href="#">
            <img src="images/post-thumbnail-1.jpg" alt="post" class="w-full h-48 object-cover rounded-md transition-transform duration-300 hover:scale-105">
          </a>
        </div>
        <div class="mt-4">
          <div class="flex items-center text-xs text-gray-500 uppercase gap-4 mb-2">
          ...
          <h3 class="text-lg font-medium">
            <a href="#" class="hover:text-blue-600 transition">Top 10 casual look ideas to dress up your kids</a>
          </h3>
          <p class="text-sm text-gray-600 mt-2">Lorem ipsum dolor sit amet, consectetur adipi elit. Aliquet eleifend viverra enim tincidunt donec quam...</p>
        </div>
      </article>
      ...
      <article class="bg-white border border-gray-100 shadow-sm rounded-lg p-4 transform transition-transform duration-300 hover:scale-[1.03]">
        <div class="overflow-hidden rounded-md">
          <a href="#">
            <img src="images/post-thumbnail-2.jpg" alt="post" class="w-full h-48 object-cover rounded-md transition-transform duration-300 hover:scale-105">
          </a>
        </div>
        <div class="mt-4">
          <div class="flex items-center text-xs text-gray-500 uppercase gap-4 mb-2">
            <div class="flex items-center gap-1">
              <svg width="16" height="16"><use xlink:href="#calendar"></use></svg> 25 Aug 2021
            </div>
            <div class="flex items-center gap-1">
          ...
          <h3 class="text-lg font-medium">
            <a href="#" class="hover:text-blue-600 transition">Latest trends of wearing street wears supremely</a>
          </h3>
          <p class="text-sm text-gray-600 mt-2">Lorem ipsum dolor sit amet, consectetur adipi elit. Aliquet eleifend viverra enim tincidunt donec quam...</p>
        </div>
      </article>
      ...
      <article class="bg-white border border-gray-100 shadow-sm rounded-lg p-4 transform transition-transform duration-300 hover:scale-[1.03]">
        <div class="overflow-hidden rounded-md">
          <a href="#">
            <img src="images/post-thumbnail-3.jpg" alt="post" class="w-full h-48 object-cover rounded-md transition-transform duration-300 hover:scale-105">
          </a>
        </div>
        <div class="mt-4">
          <div class="flex items-center text-xs text-gray-500 uppercase gap-4 mb-2">
          ...
          <h3 class="text-lg font-medium">
            <a href="#" class="hover:text-blue-600 transition">10 Different Types of comfortable clothes ideas for women</a>
          </h3>
          <p class="text-sm text-gray-600 mt-2">Lorem ipsum dolor sit amet, consectetur adipi elit. Aliquet eleifend viverra enim tincidunt donec quam...</p>
        </div>
      </article>
  ...
  <div class="max-w-7xl mx-auto px-4">
    <div class="bg-yellow-400 pt-10 rounded-3xl">
      <div class="flex flex-col md:flex-row justify-center items-center gap-8 px-6">
        
        <!-- Left Content -->
        <div class="md:w-1/2">
          <h2 class="text-2xl md:text-3xl font-semibold mt-5">Download Organic App</h2>
          <p class="mt-2 mb-4 text-gray-700">Online Orders made easy, fast and reliable</p>
          <div class="flex flex-wrap gap-3 mb-6">
            <a href="#" title="App store">
              <img src="images/img-app-store.png" alt="app-store" class="h-12">
            </a>
            <a href="#" title="Google Play">
              <img src="images/img-google-play.png" alt="google-play" class="h-12">
            </a>
          </div>
        </div>
        ...
        <!-- Right Image -->
        <div class="md:w-1/2">
          <img src="images/banner-onlineapp.png" alt="phone" class="w-full max-w-md mx-auto">
        </div>
   ...
   <div id="footer-bottom" class="bg-gray-100 py-4">
  <div class="max-w-7xl mx-auto px-4">
    <div class="flex justify-center items-center">
      <p class="text-sm text-gray-600 text-center">&copy; 2024 Organic. All rights reserved.</p>
    </div>
  </div>
</div>
